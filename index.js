...
<html lang="en">
  ...
  <div class="cards-container">
    <div class="card">
      ...
      <div class="info">
        <h4>ID: 236944</h4>
        <h4>Email: cobi.gottschalk@gmail.com</h4>
        <h4>Office number: 2</h4>
      </div>
    </div>
  </div>  
...
<div>
            <p>My favorite color is ${answers.using}</p>
            <p>Sushi like status: ${answers.username}</p>
            <p>Fancy pasta: ${answers.address}</p>
        </div>
